...
namespace API.Client {
    ...
    export class ContentCommentsApi {
         ...
         */
        public getCommentsUsingGET (context: string, contextId: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceCommentResource> {
            const localVarPath = this.basePath + '/comments';
