...
namespace API.Client {
    ...
    export class ReportingOrdersApi {
         ...
         */
        public getDailyInvoicesUsingGET (currencyCode: string, granularity?: string, filterPaymentStatus?: string, filterFulfillmentStatus?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageAggregateInvoiceReportResource> {
