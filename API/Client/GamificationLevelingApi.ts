...
namespace API.Client {
    ...
    export class GamificationLevelingApi {
         ...
         */
        public getLevelsUsingGET (filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceLevelingResource> {
            const localVarPath = this.basePath + '/leveling';
         ...
         * @param userId The id of the user
         */
        public getUserLevelsUsingGET (userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceUserLevelingResource> {
