...
namespace API.Client {
    ...
    export class StoreApi {
         ...
         */
        public createItemTemplateUsingPOST (itemTemplateResource?: ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<ItemTemplateResource> {
         ...
         * @param id The id of the template
         */
        public getItemTemplateUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<ItemTemplateResource> {
            const localVarPath = this.basePath + '/store/items/templates/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         */
        public getItemTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageItemTemplateResource> {
            const localVarPath = this.basePath + '/store/items/templates';
         ...
         */
        public getUsingGET2 (storeListRequest?: StoreListRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageStoreItem> {
         ...
         */
        public updateItemTemplateUsingPUT (id: string, itemTemplateResource?: ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/store/items/templates/{id}'
                .replace('{' + 'id' + '}', String(id));
