...
namespace API.Client {
    ...
    export class UsersInventoryApi {
         ...
         */
        public getCurrenciesUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceEntitlementItem> {
            const localVarPath = this.basePath + '/entitlements';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getEntitlementTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceItemTemplateResource> {
            const localVarPath = this.basePath + '/entitlements/templates';
         ...
         */
        public getInventoryListUsingGET (inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterUsername?: string, filterGroup?: string, filterDate?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceUserInventoryResource> {
         ...
         */
        public getUserInventoryListUsingGET (id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceUserInventoryResource> {
            const localVarPath = this.basePath + '/users/{id}/inventory'
                .replace('{' + 'id' + '}', String(id));
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getUserInventoryLogUsingGET (userId: string, id: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceUserItemLogResource> {
