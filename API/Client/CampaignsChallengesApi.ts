...
namespace API.Client {
    ...
    export class CampaignsChallengesApi {
         ...
         */
        public getActivitiesUsingGET1 (challengeId: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceBareChallengeActivityResource> {
            const localVarPath = this.basePath + '/challenges/{challenge_id}/activities'
                .replace('{' + 'challenge_id' + '}', String(challengeId));
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getChallengeEventssUsingGET (filterStartDate?: string, filterEndDate?: string, filterCampaigns?: boolean, filterChallenge?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceChallengeEventResource> {
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getChallengeTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceTemplateResource> {
            const localVarPath = this.basePath + '/challenges/templates';
         ...
         */
        public getChallengesUsingGET1 (filterTemplate?: boolean, filterActiveCampaign?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceChallengeResource> {
            const localVarPath = this.basePath + '/challenges';
