...
namespace API.Client {
    ...
    export class CampaignsChallengesApi {
         ...
         */
        public createChallengeActivityUsingPOST (challengeId: number, challengeActivityResource?: ChallengeActivityResource, validateSettings?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeActivityResource> {
         ...
         */
        public createChallengeTemplateUsingPOST (challengeTemplateResource?: TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<TemplateResource> {
         ...
         */
        public createChallengeUsingPOST (challengeResource?: ChallengeResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeResource> {
         ...
         */
        public getActivitiesUsingGET1 (challengeId: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageBareChallengeActivityResource> {
            const localVarPath = this.basePath + '/challenges/{challenge_id}/activities'
                .replace('{' + 'challenge_id' + '}', String(challengeId));
         ...
         * @param activityId The activity id
         */
        public getChallengeActivityUsingGET (activityId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeActivityResource> {
            const localVarPath = this.basePath + '/challenges/{challenge_id}/activities/{activity_id}'
                .replace('{' + 'activity_id' + '}', String(activityId));
         ...
         * @param id The challenge event id
         */
        public getChallengeEventUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeEventResource> {
            const localVarPath = this.basePath + '/challenges/events/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getChallengeEventssUsingGET (filterStartDateMin?: number, filterStartDateMax?: number, filterEndDateMin?: number, filterEndDateMax?: number, filterCampaigns?: boolean, filterChallenge?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageChallengeEventResource> {
            const localVarPath = this.basePath + '/challenges/events';

            let queryParameters: any = {};
            let headerParams: any = this.extendObj({}, this.defaultHeaders);
            if (filterStartDateMin !== undefined) {
                queryParameters['filter_start_date_min'] = filterStartDateMin;
            }

            if (filterStartDateMax !== undefined) {
                queryParameters['filter_start_date_max'] = filterStartDateMax;
            }

            if (filterEndDateMin !== undefined) {
                queryParameters['filter_end_date_min'] = filterEndDateMin;
            }

            if (filterEndDateMax !== undefined) {
                queryParameters['filter_end_date_max'] = filterEndDateMax;
            }
         ...
         * @param id The id of the template
         */
        public getChallengeTemplateUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<TemplateResource> {
            const localVarPath = this.basePath + '/challenges/templates/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getChallengeTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageTemplateResource> {
            const localVarPath = this.basePath + '/challenges/templates';
         ...
         * @param id The challenge id
         */
        public getChallengeUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeResource> {
            const localVarPath = this.basePath + '/challenges/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         */
        public getChallengesUsingGET1 (filterTemplate?: boolean, filterActiveCampaign?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageChallengeResource> {
            const localVarPath = this.basePath + '/challenges';
         ...
         * @param challengeActivityResource The challenge activity resource object
         */
        public updateChallengeActivityUsingPUT (activityId: number, challengeId: number, challengeActivityResource?: ChallengeActivityResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/challenges/{challenge_id}/activities/{activity_id}'
                .replace('{' + 'activity_id' + '}', String(activityId))
                .replace('{' + 'challenge_id' + '}', String(challengeId));
         ...
         * @param challengeTemplateResource The challenge template resource object
         */
        public updateChallengeTemplateUsingPUT (id: string, challengeTemplateResource?: TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/challenges/templates/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         * @param challengeResource The challenge resource object
         */
        public updateChallengeUsingPUT (id: number, challengeResource?: ChallengeResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<ChallengeResource> {
            const localVarPath = this.basePath + '/challenges/{id}'
                .replace('{' + 'id' + '}', String(id));
