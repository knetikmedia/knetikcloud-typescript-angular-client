...
namespace API.Client {
    ...
    export class PaymentsWalletsApi {
         ...
         * 
         */
        public getWalletTotalsUsingGET (extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceWalletTotalResponse> {
         ...
         */
        public getWalletsUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceSimpleWallet> {
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public userTransactionHistoryUsingGET (userId: number, currencyCode: string, filterType?: string, filterMaxDate?: number, filterMinDate?: number, filterSign?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceWalletTransactionResource> {
