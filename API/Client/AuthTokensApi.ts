...
namespace API.Client {
    ...
    export class AuthTokensApi {
         ...
         */
        public getTokensUsingGET (filterClientId?: string, filterUsername?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageOauthAccessTokenResource> {
