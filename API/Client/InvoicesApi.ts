...
namespace API.Client {
    ...
    export class InvoicesApi {
         ...
         */
        public createInvoiceUsingPOST (req?: InvoiceCreateRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<InvoiceResource>> {
         ...
         */
        public getInvoiceHistoryUsingGET (filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterCreatedDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceInvoiceResource> {
            const localVarPath = this.basePath + '/invoices';
         ...
         */
        public getInvoiceUsingGET (id: number, postalCode?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<InvoiceResource> {
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getLogsUsingGET (id: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceInvoiceLogEntry> {
         ...
         */
        public payInvoiceUsingPOST (id: number, request?: PayBySavedMethodRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         */
        public setPaymentStatusUsingPUT (id: number, request?: InvoicePaymentStatusRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         */
        public updateBillingInfoUsingPUT (id: number, billingInfoRequest?: AddressResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
