...
namespace API.Client {
    ...
    export class InvoicesApi {
         ...
         */
        public getInvoiceHistoryUsingGET (filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterCreatedDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageInvoiceResource> {
            const localVarPath = this.basePath + '/invoices';
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getLogsUsingGET (id: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageInvoiceLogEntry> {
