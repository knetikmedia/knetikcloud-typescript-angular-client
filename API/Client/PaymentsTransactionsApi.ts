...
namespace API.Client {
    ...
    export class PaymentsTransactionsApi {
         ...
         */
        public getTransactionsUsingGET (filterInvoice?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceTransactionResource> {
