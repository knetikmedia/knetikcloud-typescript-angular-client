...
namespace API.Client {
    ...
    export class LogsApi {
         ...
         */
        public getEventsLogsUsingGET (filterStartDate?: string, filterEventName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceBreEventLog> {
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getForwardLogsUsingGET (filterStartDate?: string, filterEndDate?: string, filterStatusCode?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceForwardLog> {
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getUserLogsUsingGET1 (filterUser?: number, filterActionName?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceUserActionLog> {
            const localVarPath = this.basePath + '/audit/logs';
