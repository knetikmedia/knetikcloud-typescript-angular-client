...
namespace API.Client {
    ...
    export class CurrenciesApi {
         ...
         */
        public getCurrenciesUsingGET (filterEnabledCurrencies?: boolean, filterType?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceCurrencyResource> {
            const localVarPath = this.basePath + '/currencies';
