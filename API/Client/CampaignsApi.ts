...
namespace API.Client {
    ...
    export class CampaignsApi {
         ...
         */
        public getCampaignTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageTemplateResource> {
            const localVarPath = this.basePath + '/campaigns/templates';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getCampaignsUsingGET (filterActive?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageCampaignResource> {
            const localVarPath = this.basePath + '/campaigns';
         ...
         * @param id The campaign id
         */
        public getChallengesUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageChallengeResource> {
            const localVarPath = this.basePath + '/campaigns/{id}/challenges'
                .replace('{' + 'id' + '}', String(id));
