...
namespace API.Client {
    ...
    export class GamificationAchievementsApi {
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getAchievementsUsingGET (filterTagset?: string, filterName?: string, filterHidden?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageAchievementDefinitionResource> {
            const localVarPath = this.basePath + '/achievements';
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getAllUserProgressForAchievementUsingGET (achievementName: string, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageUserAchievementResource> {
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getAllUserProgressUsingGET (filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageUserAchievementResource> {
         ...
         * @param achievementName The achievement&#39;s name
         */
        public getUserProgressForAchievementUsingGET (userId: number, achievementName: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<UserAchievementResource> {
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getUserProgressUsingGET (userId: number, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageUserAchievementResource> {
         ...
         */
        public updateProgressUsingPUT (userId: number, achievementName: string, request?: AchievementProgressUpdateRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<UserAchievementResource> {
            const localVarPath = this.basePath + '/users/{user_id}/achievements/{achievement_name}'
                .replace('{' + 'user_id' + '}', String(userId))
                .replace('{' + 'achievement_name' + '}', String(achievementName));
