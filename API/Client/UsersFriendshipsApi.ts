...
namespace API.Client {
    ...
    export class UsersFriendshipsApi {
         ...
         */
        public getFriendsUsingGET (userId: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageSimpleUserResource> {
         ...
         * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getInvitesUsingGET (userId: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageSimpleUserResource> {
