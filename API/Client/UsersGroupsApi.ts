...
namespace API.Client {
    ...
    export class UsersGroupsApi {
         ...
         */
        public getGroupTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceTemplateResource> {
            const localVarPath = this.basePath + '/users/groups/templates';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public searchGroupsUsingGET (uniqueName: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceGroupMemberResource> {
            const localVarPath = this.basePath + '/users/groups/{unique_name}/members'
                .replace('{' + 'unique_name' + '}', String(uniqueName));
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public searchGroupsUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceGroupResource> {
            const localVarPath = this.basePath + '/users/groups';
