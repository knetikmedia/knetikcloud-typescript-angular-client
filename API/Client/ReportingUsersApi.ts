...
namespace API.Client {
    ...
    export class ReportingUsersApi {
         ...
         */
        public executiveRevenueItemSalesUsingGET1 (granularity?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceAggregateCountResource> {
