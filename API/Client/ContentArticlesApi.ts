...
namespace API.Client {
    ...
    export class ContentArticlesApi {
         ...
         */
        public getArticleTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceTemplateResource> {
            const localVarPath = this.basePath + '/content/articles/templates';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getArticlesUsingGET (filterCategory?: string, filterTagset?: string, filterTitle?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceArticleResource> {
            const localVarPath = this.basePath + '/content/articles';
