...
namespace API.Client {
    ...
    export class MediaArtistsApi {
         ...
         */
        public getArtistTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceTemplateResource> {
            const localVarPath = this.basePath + '/media/artists/templates';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public searchArtistsUsingGET (filterArtistsByName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceArtistResource> {
            const localVarPath = this.basePath + '/media/artists';
