...
namespace API.Client {
    ...
    export class SearchApi {
         ...
         */
        public externalRegisterUsingPOST (mappings?: Array<SearchReferenceMapping>, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         */
        public searchUsingPOST (type: string, query?: any, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageMapstringobject> {
            const localVarPath = this.basePath + '/search/index/{type}'
                .replace('{' + 'type' + '}', String(type));
