...
namespace API.Client {
    ...
    export class StoreSubscriptionsApi {
         ...
         */
        public getSubscriptionTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageSubscriptionTemplateResource> {
            const localVarPath = this.basePath + '/subscriptions/templates';
        ...
        public listBillingReportsUsingGET (size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageBillingReport> {
            const localVarPath = this.basePath + '/subscriptions/reports';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public listSubscriptionsUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageSubscriptionResource> {
            const localVarPath = this.basePath + '/subscriptions';
