...
namespace API.Client {
    ...
    export class GamificationTriviaApi {
         ...
         */
        public getListUsingGET1 (filterVendor?: string, filterCategory?: string, filterName?: string, filterStatus?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceImportJobResource> {
            const localVarPath = this.basePath + '/trivia/import';
         ...
         * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
         */
        public getQuestionTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceQuestionTemplateResource> {
            const localVarPath = this.basePath + '/trivia/questions/templates';
         ...
         * @param filterImportId Filter for questions from a specific import job
         */
        public getQuestionsUsingGET (size?: number, page?: number, order?: string, filterSearch?: string, filterIdset?: string, filterCategory?: string, filterTagset?: string, filterType?: string, filterPublished?: boolean, filterImportId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceQuestionResource> {
            const localVarPath = this.basePath + '/trivia/questions';
