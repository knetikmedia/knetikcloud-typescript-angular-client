...
namespace API.Client {
    ...
    export class ActivitiesApi {
         ...
         */
        public getActivitiesUsingGET (filterTemplate?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceBareActivityResource> {
            const localVarPath = this.basePath + '/activities';
