...
namespace API.Client {
    ...
    export class MediaModerationApi {
         ...
         */
        public getFlagsReportUsingGET (excludeResolved?: boolean, filterContext?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageFlagReportResource> {
