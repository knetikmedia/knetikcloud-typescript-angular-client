...
namespace API.Client {
    ...
    export class BRERuleEngineRulesApi {
         ...
         */
        public getRulesUsingGET (filterName?: string, filterEnabled?: boolean, filterSystem?: boolean, filterTrigger?: string, filterAction?: string, filterCondition?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageBreRule> {
            const localVarPath = this.basePath + '/bre/rules';
