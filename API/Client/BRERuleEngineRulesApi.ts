...
namespace API.Client {
    ...
    export class BRERuleEngineRulesApi {
         ...
         */
        public convertExpressionToStringUsingPOST (expression?: Expressionobject, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
         ...
         */
        public createRuleUsingPOST (breRule?: BreRule, extraHttpRequestParams?: any ) : ng.IHttpPromise<BreRule> {
         ...
         */
        public enableRuleUsingPUT (id: string, enabled?: BooleanResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param id The id of the rule
         */
        public getRuleUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<BreRule> {
            const localVarPath = this.basePath + '/bre/rules/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         */
        public getRulesUsingGET (filterName?: string, filterEnabled?: boolean, filterSystem?: boolean, filterTrigger?: string, filterAction?: string, filterCondition?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceBreRule> {
            const localVarPath = this.basePath + '/bre/rules';
         ...
         * @param breRule The BRE rule object
         */
        public updateRuleUsingPUT (id: string, breRule?: BreRule, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/bre/rules/{id}'
                .replace('{' + 'id' + '}', String(id));
