...
namespace API.Client {
    ...
    export class MediaVideosApi {
         ...
         */
        public getCommentsUsingGET1 (videoId: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceCommentResource> {
            const localVarPath = this.basePath + '/media/videos/{video_id}/comments'
                .replace('{' + 'video_id' + '}', String(videoId));
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getDispositionsUsingGET1 (videoId: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceDispositionResource> {
            const localVarPath = this.basePath + '/media/videos/{video_id}/dispositions'
                .replace('{' + 'video_id' + '}', String(videoId));
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getRelatedUsingGET (videoId: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceVideoRelationshipResource> {
            const localVarPath = this.basePath + '/media/videos/{video_id}/related'
                .replace('{' + 'video_id' + '}', String(videoId));
         ...
         * @param page The number of the page returned, starting with 1
         */
        public getUserVideosUsingGET (userId: number, excludeFlagged?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<PageResourceVideoResource> {
