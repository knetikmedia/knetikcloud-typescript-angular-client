...
export class StoreCouponsApi {
    ...
    /**
        ...
        */
    public createCouponItem (couponItem?: models.CouponItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CouponItem> {
    ...
    /**
        ...
        * @param couponItem The coupon item object
        */
    public updateCouponItem (id: number, couponItem?: models.CouponItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/coupons/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateCouponTemplate (id: string, couponTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/coupons/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
