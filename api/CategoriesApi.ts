...
export class CategoriesApi {
    ...
    /**
        ...
        */
    public updateCategory (id: string, category?: models.CategoryResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/categories/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateCategoryTemplate (id: string, template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/categories/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
