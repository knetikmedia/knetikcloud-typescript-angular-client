...
export class CategoriesApi {
    ...
    /**
        ...
        */
    public createCategoryUsingPOST (category?: models.CategoryResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CategoryResource> {
    ...
    /**
        ...
        */
    public createTemplateUsingPOST2 (template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TemplateResource> {
    ...
    /**
        ...
        */
    public getArticleTemplatesUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceTemplateResource> {
        const localVarPath = this.basePath + '/categories/templates';
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public getCategoriesUsingGET1 (filterSearch?: string, filterActive?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceCategoryResource> {
        const localVarPath = this.basePath + '/categories';
    ...
    /**
        ...
        */
    public getCategoryUsingGET1 (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CategoryResource> {
        const localVarPath = this.basePath + '/categories/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public getTagsUsingGET (size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourcestring> {
    ...
    /**
        ...
        * @param id The id of the template
        */
    public getTemplateUsingGET1 (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TemplateResource> {
        const localVarPath = this.basePath + '/categories/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateCategoryUsingPUT1 (id: string, category?: models.CategoryResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/categories/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateTemplateUsingPUT2 (id: string, template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/categories/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
