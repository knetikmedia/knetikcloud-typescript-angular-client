...
export class AuthRolesApi {
    ...
    /**
        ...
        */
    public setClientRoles (clientKey: string, rolesList?: Array<string>, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/clients/{client_key}/roles'
            .replace('{' + 'client_key' + '}', String(clientKey));
    ...
    /**
        ...
        */
    public setPermissionsForRole (role: string, permissionsList?: Array<string>, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        * @param rolesList The list of unique roles
        */
    public setUserRoles (userId: number, rolesList?: Array<string>, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/users/{user_id}/roles'
            .replace('{' + 'user_id' + '}', String(userId));
    ...
    /**
        ...
        * @param roleResource The role resource object
        */
    public updateRole (role: string, roleResource?: models.RoleResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/roles/{role}'
            .replace('{' + 'role' + '}', String(role));
