...
export class AuthRolesApi {
    ...
    /**
        ...
        */
    public createRoleUsingPOST (roleResource?: models.RoleResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RoleResource> {
    ...
    /**
        ...
        * @param clientKey The client key
        */
    public getClientRolesUsingGET (clientKey: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RoleResource>> {
        const localVarPath = this.basePath + '/auth/clients/{client_key}/roles'
            .replace('{' + 'client_key' + '}', String(clientKey));
    ...
    /**
        ...
        * @param role The role value
        */
    public getRoleUsingGET (role: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RoleResource> {
        const localVarPath = this.basePath + '/auth/roles/{role}'
            .replace('{' + 'role' + '}', String(role));
    ...
    /**
        ...
        */
    public getRolesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceRoleResource> {
        const localVarPath = this.basePath + '/auth/roles';
    ...
    /**
        ...
        * @param userId The user&#39;s id
        */
    public getUserRolesUsingGET (userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RoleResource>> {
        const localVarPath = this.basePath + '/auth/users/{user_id}/roles'
            .replace('{' + 'user_id' + '}', String(userId));
    ...
    /**
        ...
        * @param roleResource The role resource object
        */
    public updateRoleUsingPUT (role: string, roleResource?: models.RoleResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/roles/{role}'
            .replace('{' + 'role' + '}', String(role));
