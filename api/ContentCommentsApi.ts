...
export class ContentCommentsApi {
    ...
    /**
        ...
        */
    public addCommentUsingPOST (commentResource?: models.CommentResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CommentResource> {
    ...
    /**
        ...
        * @param id The comment id
        */
    public getCommentUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CommentResource> {
        const localVarPath = this.basePath + '/comments/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getCommentsUsingGET (context: string, contextId: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceCommentResource> {
        const localVarPath = this.basePath + '/comments';
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public searchCommentsUsingPOST (query?: any, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CommentSearch> {
