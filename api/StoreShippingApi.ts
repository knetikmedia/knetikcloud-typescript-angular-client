...
export class StoreShippingApi {
    ...
    /**
        ...
        */
    public createShippingItem (shippingItem?: models.ShippingItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ShippingItem> {
    ...
    /**
        ...
        * @param shippingItem The shipping item object
        */
    public updateShippingItem (id: number, shippingItem?: models.ShippingItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/shipping/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateShippingTemplate (id: string, shippingTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/shipping/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
