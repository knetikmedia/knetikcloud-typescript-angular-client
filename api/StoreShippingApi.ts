...
export class StoreShippingApi {
    ...
    /**
        ...
        */
    public createShippingItemUsingPOST (shippingItem?: models.ShippingItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ShippingItem> {
    ...
    /**
        ...
        */
    public createShippingTemplateUsingPOST (shippingTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ItemTemplateResource> {
    ...
    /**
        ...
        * @param id The id of the shipping item
        */
    public getShippingItemUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ShippingItem> {
        const localVarPath = this.basePath + '/store/shipping/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param id The id of the template
        */
    public getShippingTemplateUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ItemTemplateResource> {
        const localVarPath = this.basePath + '/store/shipping/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getShippingTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceItemTemplateResource> {
        const localVarPath = this.basePath + '/store/shipping/templates';
    ...
    /**
        ...
        * @param shippingItem The shipping item object
        */
    public updateShippingItemUsingPUT (id: number, shippingItem?: models.ShippingItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/shipping/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateShippingTemplateUsingPUT (id: string, shippingTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/shipping/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
