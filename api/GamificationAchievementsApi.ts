...
export class GamificationAchievementsApi {
    ...
    /**
        ...
        */
    public createAchievementUsingPOST (achievement?: models.AchievementDefinitionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.AchievementDefinitionResource> {
    ...
    /**
        ...
        */
    public createTemplateUsingPOST (template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TemplateResource> {
    ...
    /**
        ...
        */
    public findAllByGroupNameUsingGET (name: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.AchievementDefinitionResource>> {
    ...
    /**
        ...
        * @param id The id of the template
        */
    public getAchievementTemplateUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TemplateResource> {
        const localVarPath = this.basePath + '/achievements/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getAchievementTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceTemplateResource> {
        const localVarPath = this.basePath + '/achievements/templates';
    ...
    /**
        ...
        * @param name The name of the achievement
        */
    public getAchievementUsingGET (name: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.AchievementDefinitionResource> {
        const localVarPath = this.basePath + '/achievements/{name}'
            .replace('{' + 'name' + '}', String(name));
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public getAchievementsUsingGET (filterTagset?: string, filterName?: string, filterHidden?: boolean, filterDerived?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceAchievementDefinitionResource> {
        const localVarPath = this.basePath + '/achievements';
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public getAllUserProgressForAchievementUsingGET (achievementName: string, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserAchievementGroupResource> {
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public getAllUserProgressUsingGET (filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserAchievementGroupResource> {
    ...
    /**
        ...
        * 
        */
    public getAvailableTriggersUsingGET (extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BreTriggerResource>> {
    ...
    /**
        ...
        * @param achievementName The achievement&#39;s name
        */
    public getUserProgressForAchievementUsingGET (userId: number, achievementName: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.UserAchievementGroupResource> {
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public getUserProgressUsingGET (userId: number, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserAchievementGroupResource> {
    ...
    /**
        ...
        * @param achievement The achievement definition
        */
    public updateAchievementUsingPUT (name: string, achievement?: models.AchievementDefinitionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/achievements/{name}'
            .replace('{' + 'name' + '}', String(name));
    ...
    /**
        ...
        */
    public updateProgressUsingPUT (userId: number, achievementName: string, request?: models.AchievementProgressUpdateRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.UserAchievementGroupResource> {
        const localVarPath = this.basePath + '/users/{user_id}/achievements/{achievement_name}'
            .replace('{' + 'user_id' + '}', String(userId))
            .replace('{' + 'achievement_name' + '}', String(achievementName));
    ...
    /**
        ...
        */
    public updateTemplateUsingPUT (id: string, template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/achievements/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
