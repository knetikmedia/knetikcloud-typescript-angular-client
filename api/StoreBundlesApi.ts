...
export class StoreBundlesApi {
    ...
    /**
        ...
        */
    public createBundleItem (bundleItem?: models.BundleItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BundleItem> {
    ...
    /**
        ...
        * @param bundleItem The bundle item object
        */
    public updateBundleItem (id: number, bundleItem?: models.BundleItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/bundles/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateBundleTemplate (id: string, bundleTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/bundles/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
