...
export class UsersGroupsApi {
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public updateGroups (filterName?: string, filterUniqueName?: string, filterParent?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceGroupResource> {
        const localVarPath = this.basePath + '/users/groups';
