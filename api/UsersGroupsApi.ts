...
export class UsersGroupsApi {
    ...
    /**
        ...
        */
    public addMemberToGroup (uniqueName: string, username: models.GroupMemberResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GroupMemberResource> {
    ...
    /**
        ...
        * @param groupTemplateResource The group template resource object
        */
    public updateGroupTemplate (id: string, groupTemplateResource?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/users/groups/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public updateGroups (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceGroupResource> {
        const localVarPath = this.basePath + '/users/groups';
