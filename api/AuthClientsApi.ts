...
export class AuthClientsApi {
    ...
    /**
        ...
        */
    public createClientUsingPOST (clientResource?: models.ClientResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ClientResource> {
    ...
    /**
        ...
        * @param clientKey The key of the client
        */
    public getClientUsingGET (clientKey: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ClientResource> {
        const localVarPath = this.basePath + '/auth/clients/{client_key}'
            .replace('{' + 'client_key' + '}', String(clientKey));
    ...
    /**
        ...
        */
    public getClientsUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceClientResource> {
        const localVarPath = this.basePath + '/auth/clients';
    ...
    /**
        ...
        * 
        */
    public listAvailableGrantTypesUsingGET (extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.GrantTypeResource>> {
    ...
    /**
        ...
        * @param clientResource The client resource object
        */
    public updateClientUsingPUT (clientKey: string, clientResource?: models.ClientResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/clients/{client_key}'
            .replace('{' + 'client_key' + '}', String(clientKey));
