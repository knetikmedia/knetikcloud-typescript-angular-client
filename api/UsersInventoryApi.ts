...
export class UsersInventoryApi {
    ...
    /**
        ...
        */
    public getUserInventories (id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserInventoryResource> {
        const localVarPath = this.basePath + '/users/{id}/inventory'
            .replace('{' + 'id' + '}', String(id));
