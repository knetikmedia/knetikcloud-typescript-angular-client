...
export class UsersInventoryApi {
    ...
    /**
        ...
        */
    public createEntitlementItem (entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.EntitlementItem> {
    ...
    /**
        ...
        */
    public getUserInventory1 (id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserInventoryResource> {
        const localVarPath = this.basePath + '/users/{id}/inventory'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getUserInventoryLog1 (userId: number, id: number, timestamp?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        */
    public getUsersInventory (inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterUsername?: string, filterGroup?: string, filterDate?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceUserInventoryResource> {
    ...
    /**
        ...
        * @param entitlementItem The entitlement item object
        */
    public updateEntitlementItem (entitlementId: number, entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/entitlements/{entitlement_id}'
            .replace('{' + 'entitlement_id' + '}', String(entitlementId));
    ...
    /**
        ...
        */
    public updateEntitlementTemplate (id: string, template?: models.ItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/entitlements/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
