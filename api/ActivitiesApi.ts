...
export class ActivitiesApi {
    ...
    /**
        ...
        */
    public getActivities (filterTemplate?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceBareActivityResource> {
        const localVarPath = this.basePath + '/activities';
    ...
    /**
        ...
        * @param activityResource The activity resource object
        */
    public updateActivity (id: number, activityResource?: models.ActivityResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/activities/{id}'
            .replace('{' + 'id' + '}', String(id));
