...
export class TaxesApi {
    ...
    /**
        ...
        */
    public createTaxUsingPOST (countryCodeIso3: string, taxResource?: models.StateTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        */
    public getAllTaxesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceStateTaxResource> {
    ...
    /**
        ...
        * @param countryCodeIso3 The iso3 code of the country
        */
    public getTaxUsingGET (countryCodeIso3: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CountryTaxResource> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3));
    ...
    /**
        ...
        * @param stateCode The code of the state
        */
    public getTaxUsingGET1 (countryCodeIso3: string, stateCode: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.StateTaxResource> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}/states/{state_code}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3))
            .replace('{' + 'state_code' + '}', String(stateCode));
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public getTaxesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceCountryTaxResource> {
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public getTaxesUsingGET1 (countryCodeIso3: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceStateTaxResource> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}/states'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3));
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public updateTaxUsingPOST (taxResource?: models.CountryTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/tax/countries';
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public updateTaxUsingPUT (countryCodeIso3: string, taxResource?: models.CountryTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3));
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public updateTaxUsingPUT1 (countryCodeIso3: string, stateCode: string, taxResource?: models.StateTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}/states/{state_code}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3))
            .replace('{' + 'state_code' + '}', String(stateCode));
