...
export class TaxesApi {
    ...
    /**
        ...
        */
    public createCountryTax (taxResource?: models.CountryTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public createStateTax (countryCodeIso3: string, taxResource?: models.StateTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public updateCountryTax (countryCodeIso3: string, taxResource?: models.CountryTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3));
    ...
    /**
        ...
        * @param taxResource The tax object
        */
    public updateStateTax (countryCodeIso3: string, stateCode: string, taxResource?: models.StateTaxResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/tax/countries/{country_code_iso3}/states/{state_code}'
            .replace('{' + 'country_code_iso3' + '}', String(countryCodeIso3))
            .replace('{' + 'state_code' + '}', String(stateCode));
