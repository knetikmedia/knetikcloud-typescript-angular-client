...
export class CampaignsApi {
    ...
    /**
        ...
        * @param campaignResource The campaign resource object
        */
    public updateCampaign (id: number, campaignResource?: models.CampaignResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/campaigns/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param campaignTemplateResource The campaign template resource object
        */
    public updateCampaignTemplate (id: string, campaignTemplateResource?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/campaigns/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
