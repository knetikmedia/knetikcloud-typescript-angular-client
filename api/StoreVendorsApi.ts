...
export class StoreVendorsApi {
    ...
    /**
        ...
        */
    public createVendorUsingPOST (vendor?: models.VendorResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.VendorResource> {
    ...
    /**
        ...
        * @param id The id of the vendor
        */
    public getVendorUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.VendorResource> {
        const localVarPath = this.basePath + '/vendors/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getVendorsUsingGET (filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceVendorResource> {
        const localVarPath = this.basePath + '/vendors';
    ...
    /**
        ...
        * @param vendor The vendor
        */
    public updateVendorUsingPUT (id: number, vendor?: models.VendorResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/vendors/{id}'
            .replace('{' + 'id' + '}', String(id));
