...
export class UsersSubscriptionsApi {
    ...
    /**
        ...
        */
    public getSubscriptionDetailsUsingGET (userId: number, inventoryId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InventorySubscriptionResource> {
    ...
    /**
        ...
        * @param userId The id of the user
        */
    public getSubscriptionDetailsUsingGET1 (userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.InventorySubscriptionResource>> {
    ...
    /**
        ...
        */
    public reactivateUsingPOST (userId: number, inventoryId: number, reactivateSubscriptionRequest?: models.ReactivateSubscriptionRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InvoiceResource> {
