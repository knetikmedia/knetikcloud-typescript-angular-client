...
export class BRERuleEngineCategoriesApi {
    ...
    /**
        ...
        */
    public updateBRECategory (name: string, category?: models.BreCategoryResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/bre/categories/{name}'
            .replace('{' + 'name' + '}', String(name));
    ...
    /**
        ...
        */
    public updateBRECategoryTemplate (id: string, template?: models.TemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/bre/categories/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
