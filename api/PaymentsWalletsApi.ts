...
export class PaymentsWalletsApi {
    ...
    /**
        ...
        * 
        */
    public getWalletTotalsUsingGET (extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceWalletTotalResponse> {
    ...
    /**
        ...
        */
    public getWalletUsingGET (userId: number, currencyCode: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SimpleWallet> {
    ...
    /**
        ...
        */
    public getWalletsUsingGET (userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SimpleWallet>> {
    ...
    /**
        ...
        */
    public getWalletsUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceSimpleWallet> {
    ...
    /**
        ...
        */
    public updateBalanceUsingPUT (userId: number, currencyCode: string, request?: models.WalletAlterRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.WalletTransactionResource> {
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public userTransactionHistoryUsingGET (userId: number, currencyCode: string, filterType?: string, filterMaxDate?: number, filterMinDate?: number, filterSign?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceWalletTransactionResource> {
