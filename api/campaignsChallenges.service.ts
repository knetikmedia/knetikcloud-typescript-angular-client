...
export class CampaignsChallengesService {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getChallenges(filterTemplate?: boolean, filterActiveCampaign?: boolean, filterStartDate?: string, filterEndDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<PageResourceChallengeResource> {
