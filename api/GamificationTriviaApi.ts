...
export class GamificationTriviaApi {
    ...
    /**
        ...
        */
    public addAnswersUsingPOST (questionId: string, answer?: models.AnswerResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.AnswerResource> {
    ...
    /**
        ...
        * @param filterImportId Filter for questions from a specific import job
        */
    public bulkUpdateUsingPUT (question?: models.QuestionResource, filterSearch?: string, filterIdset?: string, filterCategory?: string, filterTagset?: string, filterType?: string, filterPublished?: boolean, filterImportId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
    ...
    /**
        ...
        */
    public createQuestionTemplateUsingPOST (questionTemplateResource?: models.QuestionTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.QuestionTemplateResource> {
    ...
    /**
        ...
        */
    public createQuestionUsingPOST (question?: models.QuestionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.QuestionResource> {
        const localVarPath = this.basePath + '/trivia/questions';
    ...
    /**
        ...
        */
    public createUsingPOST (request?: models.ImportJobResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ImportJobResource> {
    ...
    /**
        ...
        */
    public getAnswerUsingGET (questionId: string, id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.AnswerResource> {
    ...
    /**
        ...
        * @param questionId The id of the question
        */
    public getAnswersUsingGET (questionId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.AnswerResource>> {
        const localVarPath = this.basePath + '/trivia/questions/{question_id}/answers'
            .replace('{' + 'question_id' + '}', String(questionId));
    ...
    /**
        ...
        */
    public getListUsingGET1 (filterVendor?: string, filterCategory?: string, filterName?: string, filterStatus?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceImportJobResource> {
        const localVarPath = this.basePath + '/trivia/import';
    ...
    /**
        ...
        * @param id The id of the template
        */
    public getQuestionTemplateUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.QuestionTemplateResource> {
        const localVarPath = this.basePath + '/trivia/questions/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
        */
    public getQuestionTemplatesUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceQuestionTemplateResource> {
        const localVarPath = this.basePath + '/trivia/questions/templates';
    ...
    /**
        ...
        * @param id The id of the question
        */
    public getQuestionUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.QuestionResource> {
        const localVarPath = this.basePath + '/trivia/questions/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getQuestionsDeltaUsingGET (since?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DeltaResource>> {
    ...
    /**
        ...
        * @param filterImportId Filter for questions from a specific import job
        */
    public getQuestionsUsingGET (size?: number, page?: number, order?: string, filterSearch?: string, filterIdset?: string, filterCategory?: string, filterTagset?: string, filterType?: string, filterPublished?: boolean, filterImportId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceQuestionResource> {
        const localVarPath = this.basePath + '/trivia/questions';
    ...
    /**
        ...
        */
    public getTagsUsingGET2 (filterSearch?: string, filterCategory?: string, filterImportId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Collectionstring> {
    ...
    /**
        ...
        * @param id The id of the job
        */
    public getUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ImportJobResource> {
        const localVarPath = this.basePath + '/trivia/import/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public startProcessUsingPOST (id: number, publishNow: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ImportJobResource> {
    ...
    /**
        ...
        */
    public updateAnswerUsingPUT (questionId: string, id: string, answer?: models.AnswerResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/trivia/questions/{question_id}/answers/{id}'
            .replace('{' + 'question_id' + '}', String(questionId))
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param questionTemplateResource The question template resource object
        */
    public updateQuestionTemplateUsingPUT (id: string, questionTemplateResource?: models.QuestionTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/trivia/questions/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateQuestionUsingPUT (id: string, question?: models.QuestionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.QuestionResource> {
        const localVarPath = this.basePath + '/trivia/questions/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public updateUsingPUT (id: number, request?: models.ImportJobResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ImportJobResource> {
        const localVarPath = this.basePath + '/trivia/import/{id}'
            .replace('{' + 'id' + '}', String(id));
