...
export class ReportingRevenueApi {
    ...
    /**
        ...
        */
    public executiveRevenueCountrySalesUsingGET (currencyCode: string, startDate?: number, endDate?: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceRevenueCountryReportResource> {
    ...
    /**
        ...
        * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time
        */
    public executiveRevenueItemSalesUsingGET (currencyCode: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RevenueReportResource> {
    ...
    /**
        ...
        * @param page The number of the page returned, starting with 1
        */
    public executiveRevenueProductSalesUsingGET (currencyCode: string, startDate?: number, endDate?: number, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceRevenueProductReportResource> {
    ...
    /**
        ...
        * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time
        */
    public executiveRevenueRefundsUsingGET (currencyCode: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RevenueReportResource> {
    ...
    /**
        ...
        * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time
        */
    public executiveRevenueSubscriptionSalesUsingGET (currencyCode: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RevenueReportResource> {
