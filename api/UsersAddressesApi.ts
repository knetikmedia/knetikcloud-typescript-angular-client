...
export class UsersAddressesApi {
    ...
    /**
        ...
        */
    public updateAddress (userId: string, id: number, savedAddressResource?: models.SavedAddressResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SavedAddressResource> {
        const localVarPath = this.basePath + '/users/{user_id}/addresses/{id}'
            .replace('{' + 'user_id' + '}', String(userId))
            .replace('{' + 'id' + '}', String(id));
