...
export class BRERuleEngineRulesApi {
    ...
    /**
        ...
        */
    public convertExpressionToStringUsingPOST (expression?: models.Expressionobject, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
    ...
    /**
        ...
        */
    public createRuleUsingPOST (breRule?: models.BreRule, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BreRule> {
    ...
    /**
        ...
        */
    public deleteRuleUsingDELETE (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        */
    public enableRuleUsingPUT (id: string, enabled?: models.BooleanResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        * @param id The id of the rule
        */
    public getRuleUsingGET (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BreRule> {
        const localVarPath = this.basePath + '/bre/rules/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getRulesUsingGET (filterName?: string, filterEnabled?: boolean, filterSystem?: boolean, filterTrigger?: string, filterAction?: string, filterCondition?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceBreRule> {
        const localVarPath = this.basePath + '/bre/rules';
    ...
    /**
        ...
        * @param breRule The BRE rule object
        */
    public updateRuleUsingPUT (id: string, breRule?: models.BreRule, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/bre/rules/{id}'
            .replace('{' + 'id' + '}', String(id));
