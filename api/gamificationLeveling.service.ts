...
export class GamificationLevelingService {
     ...
     * @param name The level schema name
     */
    public getUserLevel(userId: number, name: string, extraHttpRequestParams?: any): Observable<UserLevelingResource> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getUserLevels(userId: number, filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<PageResourceUserLevelingResource> {
