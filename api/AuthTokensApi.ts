...
export class AuthTokensApi {
    ...
    /**
        ...
        * @param clientId The id of the client
        */
    public getTokenByUserUsingGET (username: string, clientId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.OauthAccessTokenResource> {
        const localVarPath = this.basePath + '/auth/tokens/{username}/{client_id}'
            .replace('{' + 'username' + '}', String(username))
            .replace('{' + 'client_id' + '}', String(clientId));
    ...
    /**
        ...
        */
    public getTokensUsingGET (filterClientId?: string, filterUsername?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceOauthAccessTokenResource> {
