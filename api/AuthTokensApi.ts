...
export class AuthTokensApi {
    ...
    /**
        ...
        */
    public deleteToken (username: string, clientId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
    ...
    /**
        ...
        * @param username The username of the user
        */
    public deleteTokens (username: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
