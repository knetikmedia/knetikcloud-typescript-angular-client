...
export class AuthPermissionsApi {
    ...
    /**
        ...
        */
    public createPermissionUsingPOST (permissionResource?: models.PermissionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PermissionResource> {
    ...
    /**
        ...
        * @param permission The permission value
        */
    public getPermissionUsingGET (permission: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PermissionResource> {
        const localVarPath = this.basePath + '/auth/permissions/{permission}'
            .replace('{' + 'permission' + '}', String(permission));
    ...
    /**
        ...
        */
    public getPermissionUsingGET1 (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourcePermissionResource> {
        const localVarPath = this.basePath + '/auth/permissions';
    ...
    /**
        ...
        * @param permissionResource The permission resource object
        */
    public updatePermissionUsingPUT (permission: string, permissionResource?: models.PermissionResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/auth/permissions/{permission}'
            .replace('{' + 'permission' + '}', String(permission));
