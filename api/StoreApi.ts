...
export class StoreApi {
    ...
    /**
        ...
        */
    public createStoreItem (storeItem?: models.StoreItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.StoreItem> {
    ...
    /**
        ...
        */
    public updateItemTemplate (id: string, itemTemplateResource?: models.StoreItemTemplateResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/items/templates/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        * @param storeItem The store item object
        */
    public updateStoreItem (id: number, storeItem?: models.StoreItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/items/{id}'
            .replace('{' + 'id' + '}', String(id));
