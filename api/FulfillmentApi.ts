...
export class FulfillmentApi {
    ...
    /**
        ...
        */
    public createFulfillmentTypeUsingPOST (type?: models.FulfillmentType, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.FulfillmentType> {
    ...
    /**
        ...
        * @param id The id
        */
    public getFulfillmentTypeUsingGET (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.FulfillmentType> {
        const localVarPath = this.basePath + '/store/fulfillment/types/{id}'
            .replace('{' + 'id' + '}', String(id));
    ...
    /**
        ...
        */
    public getFulfillmentsUsingGET (size?: number, page?: number, order?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceFulfillmentType> {
        const localVarPath = this.basePath + '/store/fulfillment/types';
    ...
    /**
        ...
        */
    public updateFulfillmentTypeUsingPUT (id: number, fulfillmentType?: models.FulfillmentType, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/store/fulfillment/types/{id}'
            .replace('{' + 'id' + '}', String(id));
