...
export class MediaModerationApi {
    ...
    /**
        ...
        */
    public getFlagsReportUsingGET (excludeResolved?: boolean, filterContext?: string, size?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PageResourceFlagReportResource> {
    ...
    /**
        ...
        */
    public setFlagResolutionUsingPUT (id: number, flagReportResource?: models.FlagReportResource, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/moderation/reports/{id}'
            .replace('{' + 'id' + '}', String(id));
